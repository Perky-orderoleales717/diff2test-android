...
PR merge does **not** automatically create a tag or choose the next version.

That means you still decide when to release by either:

- pushing a tag manually
- or running the release workflow manually with a tag input
...
2. Decide the version, for example `v0.2.0`
3. Update the project version if needed
4. Create and push the tag
5. Let the release workflow publish `d2t.zip`
